...
public class Principal {
	...
	public static void main(String[] args) {
	  ...
	  double num_op, pecas_op, num_maior = 0, cont_m, cont_f,
				tot_pecas, cont, media_m, salario_maior = 0,
				media_f, salario_op = 0, tot_folha;
				...
				if (cont_f == 0) {
					System.out.println("NENHUM MULHER");
				}
				else {
